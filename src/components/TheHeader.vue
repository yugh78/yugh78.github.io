...
<template>
  <header class="flex justify-center p-0 mx-0 z-50 w-full items-start overflow-x-hidden fixed md:top-0 md:bottom-auto">
    <nav
      ...
      <div
        ...
        <div class="nav-icons">
          <a v-for="link in LINKS" :key="link.url" :class="'nav-i ' + link.service.color" :href="link.url"
            target="_blank">
